...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  // TODO: Telefon-Login → wenn bereit, 'email' auf 'phone' umstellen & Tab-Leiste unten einkommentieren
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-4">
          ...
          {/* ── Tab-Leiste: Telefon-Login noch nicht aktiv → ausgeblendet ──
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#009543] focus:border-transparent pr-12"
                    />
                    <button
                      type="button"
                      tabIndex={-1}
